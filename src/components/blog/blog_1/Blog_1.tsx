    ...
    return (
        <div className='blog-ctn'>
            <div className='blog-head'>
                <h1 className="blog-title">Akvarel: Barve in pigmenti</h1>
                <div className="blog-datum">Sobota, 4.3.2023</div>
            </div>
            <div className="txt-1">
                ...
                <div className='blog_1-img-descr-ctn'>
                    <img src="/blog_images/blog_1/Quinacridone gold hue.jpg" alt="Quinacridone gold hue" className="blog_1-img_1" />
                ...
                <div className="blog_1-img-descr-ctn">
                    <img src='/blog_images/blog_1/Permanent Alizarin Crimson.jpg' alt="Permanent Alizarin Crimson" className="blog_1-img_2" />
                ...
                <div className="blog_1-img-descr-ctn">
                    <img src='/blog_images/blog_1/Quinacridone gold hue tube.jpg' alt="Quinacridone gold hue tube" className="blog_1-img_3" />
                ...
                <div className="blog_1-img-descr-ctn">
                    <img src='/blog_images/blog_1/PBr7_barvni_vzorci.jpg' alt="PBr7_barvni_vzorci" className="blog_1-img_4" />
