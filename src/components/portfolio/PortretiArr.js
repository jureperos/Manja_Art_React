const PortretiArr = [
    {
        index: 0,
        src: require('./assets/portreti/brata_1.jpg'),
        title: 'Portret brata',
    ...
    },
    {
        ...
        {
        index: 4,
        src: require('./assets/portreti/santa_cat.jpg'),
        title: 'Praznična mehkoba',
        description: 'Portret mucke Jade. Medij suhi pasteli. Original fotografija z dovoljenjem @skye.reese'
    },
]


export default PortretiArr
