const ZivaliArr = [
    {
        index: 0,
        src: require('./assets/zivali/Carduelis_carduelis.jpg'),
        title: 'Lišček',
    ...
    {
        index: 1,
        src: require('./assets/zivali/Sturnus_vulgaris_sken.png'),
        title: 'Škorec',
    ...
    {
        index: 2,
        src: require('./assets/zivali/Buteo_buteo_sken.png'),
        title: 'Kanja',
        sciName: 'Buteo buteo',
    ...
    {
        index: 3,
        src: require('./assets/zivali/Troglodytes_troglodytes_sken.png'),
        title: 'Stržek',
    ...
    {
        index: 4,
        src: require('./assets/zivali/Sitta_europaea_sken.png'),
        title: 'Brglez',
    ...
    {
        index: 5,
        src: require('./assets/zivali/Garrulus_glandarius_sken.png'),
        title: 'Šoja',
    ...
    {
        index: 6,
        src: require('./assets/zivali/Pernis_apivorus.png'),
        title: 'Sršenar',
    ...
    {
        index: 7,
        src: require('./assets/zivali/Parus_major_sken.png'),
        title: 'Velika sinica',
        sciName: 'Parus major',
    ...
    {
        index: 8,
        src: require('./assets/zivali/Strix_aluco_sken.png'),
        title: 'Lesna sova',
        sciName: 'Strix aluco',
        description: 'Lesna sova na veji. Medij akvarel.'
    },
    {
        src: require('./assets/zivali/orel - Copy.png'),
        index: 9,
        title: 'Sokol selec',
    ...
    {
        index: 10,
        src: require('./assets/zivali/detel - Copy.png'),
        title: 'Detel',
